        ...
        for (var i = 0; i < products.length; i++) { // Loppar genom produkterna
            ...
            if (year != null) {
                if (products[i].year == year) {
                    ...
                    $(".showThis").html("Movies released the same year as " + " " + results[0].name).css("font-size", "20px").animate({
                        width: "100%", fontSize: "2em", borderWidth: "10px", float: "center",
                    }, 1500);

                }
                if (results[0] == null) {
                    $(".showThis").html("No match found, please try with another movie" + " ").css("font-size", "20px").animate({
                        width: "100%", fontSize: "2em", borderWidth: "10px", float: "center",
                    }, 1500);
                }
            }
            ...
            if (price != null) {
                if (products[i].price == price) {
                    results.push(products[i]);
                    $(".showThis").html("Movies with similar price as" + " " + results[0].name).css("font-size", "20px").animate({
                        width: "100%", fontSize: "2em", borderWidth: "10px", float: "center",
                    }, 1500);
